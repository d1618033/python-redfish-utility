...
# Description:  This is a sample bash script to get the Remote   #
#               Console hot-keys.                                 #
...
error(){
  echo "Usage:"
  echo        "remote: Get_Hotkey_Config.sh ^<iLO url^> ^<iLO username^>  ^<iLO password^>"
  echo        "local:  Get_Hotkey_Config.sh"
}
