...
# Description:  This is a sample bash script to know whether      #
...
error(){
  echo "Usage:"
  echo        "remote: Get_SDCard_Status.sh ^<iLO url^> ^<iLO username^>  ^<iLO password^>"
  echo        "local:  Get_SDCard_Status.sh"
}
