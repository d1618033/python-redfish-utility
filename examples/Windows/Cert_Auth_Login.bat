...
:error
echo Usage:
echo        remote: Cert_Auth_Login.bat ^<iLO url^> ^<iLO username^> ^<User Root CA Key^> ^<Root CA Certificate^> ^<User Certificate^>
echo        local:  Cert_Auth_Login.bat
