...
class ISToolCommand:
    ...
    def run(self, line, help_disp=False):
        ...
        try:
            ...
            romresults = self.rdmc.app.get_handler(
        ...
        if regresults.dict:
            ...
            for item in items:
                ...
                if schema:
                    ...
                    extref = (
                        self.rdmc.app.get_handler(locationdict, service=True, silent=True)
                        if locationdict
                        else None
                    )
        ...
        if foundreg:
            self.rdmc.ui.printer(
                "The system attribute registry was found in the " "registry repository.\n"
            )
        else:
            self.rdmc.ui.error(
                "The system attribute registry was not found in "
