...
class RdmcCommandBase(CommandBase):
    ...
    def add_login_arguments_group(self, parser):
        ...
        #         "with iLO. **NOTE**: Inclusion of this argument will force certficate based " \
        #         "authentication. A root user certificate authority key or bundle will " \
        #         "be required. ",
        #    default=None)
        #group.add_argument(
        #    '-certkey',
        ...
        #         "authentication with iLO. **NOTE 1**: Inclusion of this argument will force " \
        #         "certficate based authentication. A root user certificate authority key or " \
        #         "bundle will be required. **NOTE 2**: Inclusion of this argument will force " \
        #         "certificate based authentication. A user certificate will be required. " \
        #         "**NOTE 3**: A user will be prompted for a password if the root certificate " \
        #         "authority key is encrypted and \'-certpass/--userrootcapassword\' is omitted.",
        #    default=None)
        #group.add_argument(
        #    '-certpass',
        #    '--userrootcapassword',
        ...
        #    type=str,
        #    help="Optionally specify a user root ca key file password for encrypted user root " \
        #         "certificate authority keys. **NOTE 1**: Inclusion of this argument will force " \
        #         "certficate based authentication. A root user certificate authority key or " \
        ...
        #    dest='ca_cert_bundle',
        #    type=str,
        #    help="Specify a file path for the certificate authority bundle location (local" \
        #         " repository for certificate collection **NOTE**: Providing a custom certificate" \
        ...
        #         " This interface is deprecated, is considered unsecure. Additionally, " \
        #         " this interface may not be available by default or may not be " \
        #         " available at all on certain platforms.",
        #    default=False)
        #group.add_argument(
        #    '--force-url',
        #    dest='force_url',
        #    action="store_true",
        #    help="Force login through iLO HPRest, Redfish (includes virtual NIC ) " \
        #         "web interface.",
        #    default=False)
        group.add_argument(
            '--logout',
